...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAYMENT_PENDING', 'PAID', 'PROCESSING', 'ORDERED_FROM_SUPPLIER', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('MTN_MOMO', 'MOOV_MONEY', 'ORANGE_MONEY', 'WAVE', 'FEDAPAY', 'CARD');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_NEW', 'ORDER_PAID', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'STOCK_LOW', 'PRICE_CHANGE', 'SYSTEM');
...
CREATE TABLE "suppliers" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'AliExpress',
    "website" TEXT,
    "apiKey" TEXT,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
