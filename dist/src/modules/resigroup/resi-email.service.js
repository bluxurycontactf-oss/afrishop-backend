...
var ResiEmailService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ResiEmailService = void 0;
...
let ResiEmailService = ResiEmailService_1 = class ResiEmailService {
    constructor() {
        this.logger = new common_1.Logger(ResiEmailService_1.name);
        ...
        this.from = `ResiGo <${process.env.SMTP_USER}>`;
        this.adminEmail = process.env.ADMIN_EMAIL || process.env.SMTP_USER;
        this.phone = process.env.RESI_PHONE || '+229 97 43 93 79';
    }
    ...
    async sendAdminNotification(req) {
      ...
      <div class="wrap">
        ...
        await this.send(this.adminEmail, `🔔 Nouvelle demande ${typeLabel} — ${req.name} | ResiGo`, html);
    }
    async sendStatusUpdate(req) {
        if (!req.email || req.status !== 'DONE')
            return;
        const typeLabel = this.typeLabel(req.type);
        const html = `<!DOCTYPE html><html><head><meta charset="UTF-8">${STYLE}</head><body>
      <div class="wrap">
...
exports.ResiEmailService = ResiEmailService;
exports.ResiEmailService = ResiEmailService = ResiEmailService_1 = __decorate([
    (0, common_1.Injectable)()
], ResiEmailService);
//# sourceMappingURL=resi-email.service.js.map