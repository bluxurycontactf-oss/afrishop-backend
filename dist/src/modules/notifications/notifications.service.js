...
let NotificationsService = NotificationsService_1 = class NotificationsService {
    ...
    async sendGiftCardFirstUse(email, code, remaining, expiresAt) {
    ...
    async sendGiftCardExpired(email, code, balance, walletTransferred) {
    ...
    async sendInactivityWarning(email, firstName, daysLeft) {
    ...
    async sendAccountDeletion(email, firstName, reason, hadBalance, lostAmount) {
